...
const HelpDocs = () => {
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Creating a Ticket</h2>
        <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Managing Tickets</h2>
        <div className="bg-white rounded-lg shadow-md p-6">
          <h3 className="text-xl font-medium text-gray-700 mb-3">Viewing Tickets</h3>
          ...
          <h3 className="text-xl font-medium text-gray-700 mt-6 mb-3">Ticket Status</h3>
          <ul className="list-disc list-inside space-y-2 text-gray-600">
